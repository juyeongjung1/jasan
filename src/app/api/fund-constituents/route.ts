...
const FUND_CONSTITUENTS_DATABASE: Record<string, FundConstituentsDetail> = {
  ...
  tokyomarine_foreign: {
    ...
    constituents: [
      ...
      { rank: 8, symbol: 'LLY', name: 'Eli Lilly (米国)', nameKo: '일라이 릴리 (미국)', weightPct: 1.1, sector: 'ヘルスケア', sectorKo: '헬스ケ어', description: '肥満症薬・糖尿病薬', descriptionKo: '비만치료제·당뇨병 신약' },
  ...
  us_bond_20y: {
    ...
    constituents: [
      ...
      { rank: 3, symbol: 'US-T 4.125% 2053', name: '米国財務省証券 4.125% 2053/08/15', nameKo: '미국 재무부 채권 4.125% 2053년 만기', weightPct: 5.4, sector: '米国債', sectorKo: '미国 국채', description: '超長期固定利付国債', descriptionKo: '초장기 고정금리 국채' },
