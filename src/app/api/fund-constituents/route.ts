...
const FUND_CONSTITUENTS_DATABASE: Record<string, FundConstituentsDetail> = {
  ...
  fang_plus: {
    ...
    constituents: [
      ...
      },
      {
        ...
        descriptionKo: '검색 및 유튜브의 독점적 현금흐름과 자체 AI 가속기 TPU 경쟁力',
      },
      {
        rank: 9,
        symbol: 'NFLX',
  ...
  tokyomarine_foreign: {
    ...
    constituents: [
      ...
      { rank: 5, symbol: 'META', name: 'Meta Platforms (米国)', nameKo: '메타 (米国)', weightPct: 1.8, sector: '通信', sectorKo: '통신', description: 'SNS・AI', descriptionKo: '글로벌 SNS·AI' },
      ...
      { rank: 8, symbol: 'LLY', name: 'Eli Lilly (米国)', nameKo: '일ライ 릴리 (미국)', weightPct: 1.1, sector: 'ヘルスケア', sectorKo: '헬스케어', description: '肥満症薬・糖尿病薬', descriptionKo: '비만치료제·당뇨병 신약' },
  ...
  sp500: {
    ...
    sectorBreakdown: [
      ...
      { sector: 'ヘルスケア (Healthcare)', sectorKo: '헬스ケ어', weightPct: 11.6, color: '#EC4899' },
