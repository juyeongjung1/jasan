...
// 각 펀드의 최신 공시 구성종목 및 리밸런싱 규칙 데이터베이스
const FUND_CONSTITUENTS_DATABASE: Record<string, FundConstituentsDetail> = {
  ztech20: {
    ...
    benchmarkIndex: 'Solactive US Big Tech 20 Index (税引後配当込み、円換算)',
    benchmarkIndexKo: 'Solactive US Big Tech 20 지수 (원화/엔화 환산)',
    rebalanceRules:
      '米国上場企業から、世界のメガトレンドを牽引するビッグテクノロジー時価総額上位20銘柄を選定。半期ごと（5月・11月）に銘柄入替および時価総額加重（上位集中度制限あり）でリバランスを実施。',
    rebalanceRulesKo:
      '미국 상장 기업 중 글로벌 메가트렌드를 주도하는 빅테크 시가총액 상위 20개 종목을 엄선. 반기별(5월·11월)로 종목 교체 및 유동 시가총액 가중 방식으로 리밸런싱을 실시합니다.',
    totalHoldingsCount: 20,
    top10WeightPct: 75.8,
    asOfDate: '2026年最新 月報公表値',
    sectorBreakdown: [
      { sector: '半導体・AIハードウェア', sectorKo: '반도체·AI 하드웨어', weightPct: 38.5, color: '#6366F1' },
      { sector: 'クラウド・エンタープライズソフト', sectorKo: '클라우드·엔터프라이즈 SW', weightPct: 24.2, color: '#3B82F6' },
      { sector: 'インタラクティブ・メディア・AI検索', sectorKo: '인터랙티브 미디어·AI 검색', weightPct: 15.6, color: '#EC4899' },
      { sector: 'コンシューマー・Eコマース・EV', sectorKo: '소비재·E커머스·EV', weightPct: 14.2, color: '#F59E0B' },
      { sector: 'サイバーセキュリティ・データ解析', sectorKo: '사이버 보안·데이터 분석', weightPct: 7.5, color: '#10B981' },
    ],
    constituents: [
      {
        rank: 1,
      ...
      },
      {
        ...
        weightPct: 10.4,
        sector: 'クラウド・AIソフトウェア',
        sectorKo: '클라우드·AI 소프트웨어',
      ...
      },
      {
        ...
        description: 'Llama 3によるAI広告高効率化と30億人超のSNSユーザー網',
        descriptionKo: 'Llama 3를 통한 고효율 AI 광고 최적화 및 30억 사용자망',
      },
      {
        rank: 7,
        symbol: 'AVGO',
        ...
        weightPct: 6.9,
        sector: 'カスタムAI半導体・通信チップ',
        sectorKo: '커스텀 AI 반도체·통신 칩',
        description: '大手テック向けカスタムAI ASIC（XPU）および通信インフラ',
        descriptionKo: '빅테크 맞춤형 AI ASIC(XPU) 및 차세대 통신 인프라 독점',
      },
      {
        rank: 8,
        symbol: 'TSLA',
        ...
        nameKo: '테슬라 (Tesla)',
        weightPct: 5.5,
        sector: 'EV・自動運転(FSD)・人型ロボット',
        sectorKo: 'EV·자율주행(FSD)·휴머노이드',
        description: 'FSD完全自動運転、Optimusロボット、エネルギー蓄電システム',
        descriptionKo: 'FSD 완전 자율주행, Optimus 로봇, 차세대 에너지 저장장치',
      },
      {
        rank: 9,
        symbol: 'PLTR',
        ...
        weightPct: 4.2,
        sector: 'エンタープライズAI基盤(AIP)',
        sectorKo: '엔터프라이즈 AI 플랫폼(AIP)',
        description: '防衛・民間企業の業務を革新するAIプラットフォームAIPの急拡大',
        descriptionKo: '국방 및 민간 기업의 핵심 업무를 혁신하는 AIP 플랫폼 급성장',
      },
      {
        rank: 10,
        symbol: 'AMD',
        ...
        nameKo: 'AMD',
        weightPct: 3.8,
        sector: 'データセンターGPU・CPU',
        sectorKo: '데이터센터 GPU·CPU',
        description: 'MI300シリーズによるデータセンターAIアクセラレータ第2極',
        descriptionKo: 'MI300 시리즈로 데이터센터 AI 가속기 시장 2위 확보',
      },
      {
        rank: 11,
        symbol: 'NFLX',
        ...
        weightPct: 3.5,
        sector: 'ストリーミング・広告配信',
        sectorKo: '스트리밍·광고 플랫폼',
        description: '世界最大の有料会員基盤と広告つきプランによる高収益化',
        descriptionKo: '글로벌 유료 구독자 기반과 광고 요금제를 통한 수익성 극대화',
      },
      {
        rank: 12,
        symbol: 'QCOM',
        ...
        nameKo: '퀄컴 (Qualcomm)',
        weightPct: 3.2,
        sector: 'オンデバイスAI・モバイルプロセッサ',
        sectorKo: '온디바이스 AI·모바일 프로세서',
        description: 'Snapdragon X Eliteによる次世代Copilot+ PC・スマホAI',
        descriptionKo: '스냅드래곤 X 엘리트 기반 차세대 AI PC 및 스마트폰 시장 주도',
      },
      {
        rank: 13,
        symbol: 'NOW',
      ...
      },
      {
        rank: 20,
        symbol: 'TXN',
        name: 'Texas Instruments (テキサスインスツルメンツ)',
        nameKo: '텍사스 인스트루먼트 (TI)',
        weightPct: 1.3,
        sector: 'アナログ半導体・組込みプロセッサ',
        sectorKo: '아날로그 반도체·임베디드 프로세서',
        description: '産業・自動車・エレクトロニクス向けアナログICの世界的巨人',
        descriptionKo: '산업·전장·전자제품 전반에 탑재되는 아날로그 반도체 글로벌 리더',
      },
    ],
    officialUrl: 'https://www.daiwa-am.co.jp/funds/detail/3472/detail_top.html',
  },
  ...
  fang_plus: {
    ...
    rebalanceRules:
      '固定のコア6銘柄（Meta, Apple, Amazon, Netflix, Alphabet, Microsoft）と、時価総額および取引代金上位の厳選4銘柄（計10銘柄）で構成。四半期ごと（3月・6月・9月・12月）に各10%ずつの等金額配分（イコールウェイト）へ完全リバランス。',
    rebalanceRulesKo:
      '고정 핵심 6종목(메타, 애플, 아마존, 넷플릭스, 구글, 마이크로소프트)과 시가총액·거래대금 상위 엄선 4종목(총 10종목)으로 구성. 분기별(3, 6, 9, 12월)로 10%씩 완전 균등 분할 리밸런싱을 실행합니다.',
    totalHoldingsCount: 10,
    top10WeightPct: 100.0,
    asOfDate: '2026年最新 四半期リバランス値',
    sectorBreakdown: [
      { sector: 'ハイテク・AIクラウド', sectorKo: '하이테크·AI 클라우드', weightPct: 40.0, color: '#3B82F6' },
      { sector: '半導体・ネットワーク', sectorKo: '반도체·네트워크', weightPct: 30.0, color: '#6366F1' },
      { sector: 'コンシューマー・コンテンツ・EV', sectorKo: '소비자·콘텐츠·EV', weightPct: 30.0, color: '#EC4899' },
    ],
    constituents: [
      {
        rank: 1,
      ...
      },
      {
        ...
        nameKo: '메타 플랫폼스 (Meta)',
        weightPct: 10.1,
        sector: 'SNS・オープンAI(Llama)',
        sectorKo: 'SNS·오픈 AI(Llama)',
        description: 'Instagram/WhatsAppの世界最強広告エンジンとLlamaエコシステム',
      ...
      },
      {
        ...
        sector: 'EV・自動運転AI',
        sectorKo: 'EV·자율주행 AI',
        description: 'AI自動運転ネットワーク、メガパック蓄電、ロボティクス',
        descriptionKo: 'AI 자율주행 네트워크, 메가팩 에너지 저장, 로보틱스 비전',
      },
      {
        rank: 10,
        symbol: 'SNOW',
        name: 'Snowflake (スノーフレイク)',
        nameKo: '스노우플레이크 (Snowflake)',
        weightPct: 9.7,
        sector: 'クラウドデータウェアハウス',
        sectorKo: '클라우드 데이터 웨어하우스',
        description: '企業データを安全に統合・AIモデル連携するデータクラウド標準',
        descriptionKo: '기업 빅데이터를 통합 관리하고 AI 모델과 연결하는 데이터 클라우드',
      },
    ],
    officialUrl: 'https://www.daiwa-am.co.jp/funds/detail/3336/detail_top.html',
  },
  ...
  levnas: {
    ...
    constituents: [
      ...
      { rank: 5, symbol: 'AVGO', name: 'Broadcom', nameKo: 'ブロードコム', weightPct: 4.8, sector: '半導体', sectorKo: '반도체', description: 'カスタムAI半導体', descriptionKo: '커스텀 AI ASIC, 통신 칩' },
    ...
    officialUrl: 'https://www.rakuten-toushin.co.jp/fund/nav/rilnas/',
  },
  ...
  tokyomarine_foreign: {
    ...
    constituents: [
      ...
      { rank: 3, symbol: 'NVDA', name: 'NVIDIA (米国)', nameKo: '엔비ディ아 (미국)', weightPct: 4.1, sector: 'IT', sectorKo: 'IT', description: 'AI半導体', descriptionKo: 'AI 가속기 반도체' },
      ...
      { rank: 7, symbol: 'AVGO', name: 'Broadcom (米国)', nameKo: '브로드컴 (미국)', weightPct: 1.3, sector: 'IT', sectorKo: 'IT', description: '半導体', descriptionKo: '커스텀 AI 반도체' },
    ...
    officialUrl: 'https://www.tokiam.co.jp/',
  },
